...
import { FaBed,FaBath,FaRulerCombined,FaMoneyBill,FaMapMarker, FaSquareFull } from 'react-icons/fa'
      ...
      <Image
            ...
            <div className="p-4">
              ...
              <div className="flex justify-center gap-4 text-gray-500 mb-4">
                <p>
                  <FaBed className='mx-4 md:hidden lg:inline' /> {property.beds}{' '}
                  <span className="md:hidden lg:inline">Beds</span>
                </p>
                <p>
                  <FaBath className='mx-4 md:hidden lg:inline'/> {property.baths}{' '}
                  <span className="md:hidden lg:inline">Baths</span>
                </p>
                <p>
                  <FaSquareFull className='md:hidden lg:inline'/>
              ...
              >
                <p><FaMoneyBill className=' lg:inline' /> Weekly</p>
                <p><FaMoneyBill className=' lg:inline'  /> Monthly</p>
              </div>
